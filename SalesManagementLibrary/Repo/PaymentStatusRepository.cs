...
public class PaymentStatusRepository : IPaymentStatusRepository
{
    ...
    // Create
    public async Task<PaymentStatusModel?> CreatePaymentStatusAsync(PaymentStatusCreateDto paymentStatusCreateDto)
    {
        var parameters = new
        {
    ...
    {
        var result = await _dapperDataAccess
            .LoadData<PaymentStatusModel?, dynamic>("[dbo].[PaymentStatusesGetById]", new { PaymentStatusId = id}, "DefaultConnection");
    ...
    public Task UpdatePaymentStatusAsync(int id, PaymentStatusCreateDto paymentStatusCreateDto)
    {
        ...
        return _dapperDataAccess.SaveData<dynamic>("[dbo].[PaymentStatusesUpdate]", parameter,"DefaultConnection");
    }
    ...
    public Task DeletePaymentStatusAsync(int id)
    {
        return _dapperDataAccess
            .SaveData<dynamic>("[dbo].[PaymentStatusesDelete]", new { PaymentStatusId = id}, "DefaultConnection");
    }
